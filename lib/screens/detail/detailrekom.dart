...
import 'package:aplikasirental_ps/screens/homepage/homepage.dart'; // Import file homepage.dart untuk mengakses MainScreen
...
// Kelas DetailRekom adalah StatefulWidget yang menampilkan detail rekomendasi item
class DetailRekom extends StatefulWidget {
  final String imagePath; // Path gambar item rekomendasi
  final String title; // Judul item rekomendasi
  final String subtitle; // Subjudul atau deskripsi item rekomendasi
  ...
  @override
  _DetailRekomState createState() => _DetailRekomState();
}

// Kelas PriceDuration merepresentasikan harga dan durasi sewa opsi item rekomendasi
class PriceDuration {
...
// _DetailRekomState adalah State class untuk DetailRekom
class _DetailRekomState extends State<DetailRekom> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => MainScreen(userId: 'user_id',), // Kembali ke halaman MainScreen dengan mengirimkan user_id
              ),
            );
          },
        ),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(widget.imagePath), // Menampilkan gambar item rekomendasi
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Row(
                children: <Widget>[
                  Expanded(
                    child: Text(
                      widget.title, // Menampilkan judul item rekomendasi
                      style: TextStyle(
                        fontSize: 24,
              ...
              SizedBox(height: 8),
              Text(
                widget.subtitle, // Menampilkan subjudul atau deskripsi item rekomendasi
                style: TextStyle(
                  fontSize: 16,
                  color: PrimaryTextColor, // Warna teks dari constants.dart
                ),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (selectedPriceDuration != null) {
                      // Menambahkan item rekomendasi yang dipilih ke dalam keranjang belanja
                      Item newItem = Item(
